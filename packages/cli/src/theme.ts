...
const CLASSIC_CHESS: Theme = {
  ...
  colors: {
    primary: theme.gold,
    planMode: theme.walnut,
    selection: theme.cream,
    thinking: theme.walnut,
    success: "#A9C08C",
    error: "#D06A5E",
    info: theme.cream,
    background: "#14100B",
    surface: "#221B13",
    dialogSurface: "#0F0C08",
    thinkingBorder: "#4A3B29",
    dimSeparator: theme.faint,
  },
};
...
export const DEFAULT_THEME: Theme = CLASSIC_CHESS;

...
const ACHIEVEMENTS: AchievementSeed[] = [
  ...
  },
  {
    code: "RUSH_FIRST",
    name: "On the Clock",
    description: "Finish a Puzzle Rush run.",
    xpReward: 30,
    coinReward: 15,
  },
  {
    code: "RUSH_10",
    name: "Warmed Up",
    description: "Solve 10 puzzles in a single Rush run.",
    xpReward: 150,
    coinReward: 75,
  },
  {
    code: "RUSH_20",
    name: "On a Tear",
    description: "Solve 20 puzzles in a single Rush run.",
    xpReward: 500,
    coinReward: 250,
  },
  {
    code: "RUSH_30",
    name: "Unstoppable",
    description: "Solve 30 puzzles in a single Rush run.",
    xpReward: 1200,
    coinReward: 600,
    secret: true,
  },
